...
var Brush = function () {
  function Brush(cfg) {
    ...
    this.yField = null;
    /**
     * Whether to filter the dataï¼Œdefault is true
     * @type {Boolean}
     */
...
var Util = {
  ...
  /**
   * æ·»åŠ äº‹ä»¶ç›‘å¬å™¨
   * @param  {Object} target DOMå¯¹è±¡
   * @param  {String} eventType äº‹ä»¶å
   * @param  {Funtion} callback å›žè°ƒå‡½æ•°
   * @return {Object} è¿”å›žå¯¹è±¡
   */
  ...
  /**
   * å°è£…äº‹ä»¶ï¼Œä¾¿äºŽä½¿ç”¨ä¸Šä¸‹æ–‡this,å’Œä¾¿äºŽè§£é™¤äº‹ä»¶æ—¶ä½¿ç”¨
   * @protected
   * @param  {Object} obj   å¯¹è±¡
   * @param  {String} action äº‹ä»¶åç§°
   * @return {Function}        è¿”å›žäº‹ä»¶å¤„ç†å‡½æ•°
   */
